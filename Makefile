...
CFLAGS  = -Wall -specs=psp2.specs $(INCLUDES) $(DEFINES) -fno-exceptions -fno-unwind-tables -fno-asynchronous-unwind-tables -O3 -ftree-vectorize -mfloat-abi=hard -ffast-math -fsingle-precision-constant -ftree-vectorizer-verbose=2 -fopt-info-vec-optimized -funroll-loops 
