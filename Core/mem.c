...
=======================================
- Fixed Memory Read/Writes for allignment issues on Risc Cpus
- Added 24Bit Read/Writes
...
void store24(_u32 address, _u32 data)
{
	_u8* ptr = translate_address_write(address);
